...
func (p *NetworkServiceCallbackProxy) OnRequestNetworkRegistrationInfoComplete(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorINetworkServiceCallback, MethodINetworkServiceCallbackOnRequestNetworkRegistrationInfoComplete)
