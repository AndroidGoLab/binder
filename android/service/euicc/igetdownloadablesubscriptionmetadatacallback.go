...
func (p *GetDownloadableSubscriptionMetadataCallbackProxy) OnComplete(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIGetDownloadableSubscriptionMetadataCallback, MethodIGetDownloadableSubscriptionMetadataCallbackOnComplete)
