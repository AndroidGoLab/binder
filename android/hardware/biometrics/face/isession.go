...
import (
	"context"
	"fmt"
	biometricsCommon "github.com/AndroidGoLab/binder/android/hardware/biometrics/common"
...
func (p *SessionProxy) EnrollWithOptions(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorISession)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISession, MethodISessionEnrollWithOptions)
	_compiledDescs := []string{
