...
func (p *CallNotificationEventCallbackProxy) OnCallNotificationPosted(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICallNotificationEventCallback, MethodICallNotificationEventCallbackOnCallNotificationPosted)
...
func (p *CallNotificationEventCallbackProxy) OnCallNotificationRemoved(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICallNotificationEventCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICallNotificationEventCallback, MethodICallNotificationEventCallbackOnCallNotificationRemoved)
	_compiledDescs := []string{
		"Ljava/lang/String;",
		"Landroid/os/UserHandle;",
	}
