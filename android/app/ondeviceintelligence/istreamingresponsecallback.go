...
func (p *StreamingResponseCallbackProxy) OnNewContent(
	...
	_, _err := p.remote.Transact(ctx, TransactionIStreamingResponseCallbackOnNewContent, binder.FlagOneway, _data)
	return _err
}
...
func (p *StreamingResponseCallbackProxy) OnSuccess(
	...
	_, _err := p.remote.Transact(ctx, TransactionIStreamingResponseCallbackOnSuccess, binder.FlagOneway, _data)
	return _err
}
...
func (p *StreamingResponseCallbackProxy) OnFailure(
	...
	_, _err := p.remote.Transact(ctx, TransactionIStreamingResponseCallbackOnFailure, binder.FlagOneway, _data)
	return _err
}
...
func (p *StreamingResponseCallbackProxy) OnDataAugmentRequest(
	...
	_, _err := p.remote.Transact(ctx, TransactionIStreamingResponseCallbackOnDataAugmentRequest, binder.FlagOneway, _data)
	return _err
}
