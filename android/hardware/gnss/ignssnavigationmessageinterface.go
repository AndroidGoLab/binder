...
func (p *GnssNavigationMessageInterfaceProxy) SetCallback(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIGnssNavigationMessageInterface, MethodIGnssNavigationMessageInterfaceSetCallback)
	_compiledDescs := []string{
		"Landroid/hardware/gnss/IGnssNavigationMessageCallback;",
	}
