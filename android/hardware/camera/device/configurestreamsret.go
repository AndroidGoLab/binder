...
var _ parcel.Parcelable = (*ConfigureStreamsRet)(nil)
...
func (s *ConfigureStreamsRet) MarshalParcel(
	...
	if s.HalStreams == nil {
		...
		p.WriteInt32(int32(len(s.HalStreams)))
		for _, _item := range s.HalStreams {
...
func (s *ConfigureStreamsRet) UnmarshalParcel(
	...
	if _count0 >= 0 {
		s.HalStreams = make([]HalStream, _count0)
		for _i := int32(0); _i < _count0; _i++ {
			if _err = s.HalStreams[_i].UnmarshalParcel(p); _err != nil {
				return _err
			}
		}
	}
