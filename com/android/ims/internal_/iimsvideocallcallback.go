...
func (p *ImsVideoCallCallbackProxy) ReceiveSessionModifyRequest(
	...
	_, _err := p.remote.Transact(ctx, TransactionIImsVideoCallCallbackReceiveSessionModifyRequest, binder.FlagOneway, _data)
	return _err
}
...
func (p *ImsVideoCallCallbackProxy) ReceiveSessionModifyResponse(
	...
	_, _err := p.remote.Transact(ctx, TransactionIImsVideoCallCallbackReceiveSessionModifyResponse, binder.FlagOneway, _data)
	return _err
}
...
func (p *ImsVideoCallCallbackProxy) HandleCallSessionEvent(
	...
	_, _err := p.remote.Transact(ctx, TransactionIImsVideoCallCallbackHandleCallSessionEvent, binder.FlagOneway, _data)
	return _err
}
...
func (p *ImsVideoCallCallbackProxy) ChangePeerDimensions(
	...
	_, _err := p.remote.Transact(ctx, TransactionIImsVideoCallCallbackChangePeerDimensions, binder.FlagOneway, _data)
	return _err
}
...
func (p *ImsVideoCallCallbackProxy) ChangeCallDataUsage(
	...
	_, _err := p.remote.Transact(ctx, TransactionIImsVideoCallCallbackChangeCallDataUsage, binder.FlagOneway, _data)
	return _err
}
...
func (p *ImsVideoCallCallbackProxy) ChangeCameraCapabilities(
	...
	_, _err := p.remote.Transact(ctx, TransactionIImsVideoCallCallbackChangeCameraCapabilities, binder.FlagOneway, _data)
	return _err
}
...
func (p *ImsVideoCallCallbackProxy) ChangeVideoQuality(
	...
	_, _err := p.remote.Transact(ctx, TransactionIImsVideoCallCallbackChangeVideoQuality, binder.FlagOneway, _data)
	return _err
}
