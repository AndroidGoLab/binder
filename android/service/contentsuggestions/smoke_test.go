...
func TestSmoke_ContentSuggestionsServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewContentSuggestionsServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("ContentSuggestionsServiceProxy: %d/%d passed, %d panicked, %d failed",
