...
func (p *OnMediaKeyEventSessionChangedListenerProxy) OnMediaKeyEventSessionChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIOnMediaKeyEventSessionChangedListener, MethodIOnMediaKeyEventSessionChangedListenerOnMediaKeyEventSessionChanged)
