...
func TestSmoke_RemoteMemoryIntArrayProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewRemoteMemoryIntArrayProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("RemoteMemoryIntArrayProxy: %d/%d passed, %d panicked, %d failed",
