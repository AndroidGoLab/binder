...
func TestSmoke_KeyAttestationApplicationIdProviderProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewKeyAttestationApplicationIdProviderProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("KeyAttestationApplicationIdProviderProxy: %d/%d passed, %d panicked, %d failed",
