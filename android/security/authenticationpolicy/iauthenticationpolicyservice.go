...
func (p *AuthenticationPolicyServiceProxy) EnableSecureLockDevice(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIAuthenticationPolicyServiceEnableSecureLockDevice, 0, _data)
	if _err != nil {
		return _result, _err
	}
...
func (p *AuthenticationPolicyServiceProxy) DisableSecureLockDevice(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIAuthenticationPolicyServiceDisableSecureLockDevice, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
