...
func (p *FingerprintAuthenticatorsRegisteredCallbackProxy) OnAllAuthenticatorsRegistered(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIFingerprintAuthenticatorsRegisteredCallback, MethodIFingerprintAuthenticatorsRegisteredCallbackOnAllAuthenticatorsRegistered)
