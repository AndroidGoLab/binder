...
func (p *LoudnessCodecUpdatesDispatcherProxy) DispatchLoudnessCodecParameterChange(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorILoudnessCodecUpdatesDispatcher, MethodILoudnessCodecUpdatesDispatcherDispatchLoudnessCodecParameterChange)
