...
func (p *EvsDisplayProxy) GetDisplayInfo(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIEvsDisplayGetDisplayInfo, 0, _data)
	if _err != nil {
		return _result, _err
	}
...
func (p *EvsDisplayProxy) GetDisplayState(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIEvsDisplayGetDisplayState, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *EvsDisplayProxy) GetTargetBuffer(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIEvsDisplayGetTargetBuffer, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *EvsDisplayProxy) ReturnTargetBufferForDisplay(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIEvsDisplayReturnTargetBufferForDisplay, 0, _data)
	if _err != nil {
		return _err
	}
	defer _reply.Recycle()
...
func (p *EvsDisplayProxy) SetDisplayState(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIEvsDisplaySetDisplayState, 0, _data)
	if _err != nil {
		return _err
	}
	defer _reply.Recycle()
