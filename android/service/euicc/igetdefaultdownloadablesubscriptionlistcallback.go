...
func (p *GetDefaultDownloadableSubscriptionListCallbackProxy) OnComplete(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIGetDefaultDownloadableSubscriptionListCallback, MethodIGetDefaultDownloadableSubscriptionListCallbackOnComplete)
