...
func (p *VoiceInteractionAccessibilitySettingsListenerProxy) OnAccessibilityDetectionChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIVoiceInteractionAccessibilitySettingsListener, MethodIVoiceInteractionAccessibilitySettingsListenerOnAccessibilityDetectionChanged)
