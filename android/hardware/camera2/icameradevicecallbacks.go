...
func (p *CameraDeviceCallbacksProxy) OnDeviceError(
	ctx context.Context,
	errorCode int32,
	resultExtras impl.CaptureResultExtras,
) error {
	_data := parcel.New()
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICameraDeviceCallbacks)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICameraDeviceCallbacks, MethodICameraDeviceCallbacksOnDeviceError)
...
func (p *CameraDeviceCallbacksProxy) OnCaptureStarted(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICameraDeviceCallbacks)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICameraDeviceCallbacks, MethodICameraDeviceCallbacksOnCaptureStarted)
	_compiledDescs := []string{
		"Landroid/hardware/camera2/impl/CaptureResultExtras;",
		"J",
	}
...
func (p *CameraDeviceCallbacksProxy) OnResultReceived(
	...
	resultExtras impl.CaptureResultExtras,
	physicalCaptureResultInfos []impl.PhysicalCaptureResultInfo,
) error {
	_data := parcel.New()
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICameraDeviceCallbacks)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICameraDeviceCallbacks, MethodICameraDeviceCallbacksOnResultReceived)
	_compiledDescs := []string{
...
func (p *CameraDeviceCallbacksProxy) OnPrepared(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICameraDeviceCallbacks)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICameraDeviceCallbacks, MethodICameraDeviceCallbacksOnPrepared)
	_compiledDescs := []string{
		"I",
	}
	if _sig == nil || binder.SignatureMatches(_compiledDescs, _sig) {
...
func (p *CameraDeviceCallbacksProxy) OnRepeatingRequestError(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICameraDeviceCallbacks)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICameraDeviceCallbacks, MethodICameraDeviceCallbacksOnRepeatingRequestError)
	_compiledDescs := []string{
		"J",
		"I",
	}
...
func (s *CameraDeviceCallbacksStub) OnTransaction(
	...
	case TransactionICameraDeviceCallbacksOnDeviceError:
		...
		var _arg_resultExtras impl.CaptureResultExtras
		{
	...
	case TransactionICameraDeviceCallbacksOnResultReceived:
		...
		var _arg_physicalCaptureResultInfos []impl.PhysicalCaptureResultInfo
		{
			...
			if _count >= 0 {
				_arg_physicalCaptureResultInfos = make([]impl.PhysicalCaptureResultInfo, _count)
