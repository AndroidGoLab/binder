...
func (p *BluetoothPbapProxy) GetConnectedDevices(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothPbap, MethodIBluetoothPbapGetConnectedDevices)
...
func (p *BluetoothPbapProxy) GetDevicesMatchingConnectionStates(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBluetoothPbap)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothPbap, MethodIBluetoothPbapGetDevicesMatchingConnectionStates)
	_compiledDescs := []string{
		"[I",
		"Landroid/content/AttributionSource;",
	}
...
func (p *BluetoothPbapProxy) GetConnectionState(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBluetoothPbap)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothPbap, MethodIBluetoothPbapGetConnectionState)
	_compiledDescs := []string{
...
func (p *BluetoothPbapProxy) Disconnect(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBluetoothPbap)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothPbap, MethodIBluetoothPbapDisconnect)
	_compiledDescs := []string{
		"Landroid/bluetooth/BluetoothDevice;",
		"Landroid/content/AttributionSource;",
	}
...
func (p *BluetoothPbapProxy) SetConnectionPolicy(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBluetoothPbap)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothPbap, MethodIBluetoothPbapSetConnectionPolicy)
	_compiledDescs := []string{
		"Landroid/bluetooth/BluetoothDevice;",
		"I",
		"Landroid/content/AttributionSource;",
