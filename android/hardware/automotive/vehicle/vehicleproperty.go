...
const (
	...
	VehiclePropertyInfoModelTrim                                    VehicleProperty = (((269 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeSTRING))
	VehiclePropertyInfoVehicleSizeClass                             VehicleProperty = (((270 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeInt32Vec))
	...
	VehiclePropertyInstantaneousFuelEconomy                         VehicleProperty = (((529 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeFLOAT))
	VehiclePropertyInstantaneousEvEfficiency                        VehicleProperty = (((530 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeFLOAT))
	...
	VehiclePropertyAcceleratorPedalCompressionPercentage            VehicleProperty = (((783 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeFLOAT))
	VehiclePropertyBrakePedalCompressionPercentage                  VehicleProperty = (((784 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeFLOAT))
	VehiclePropertyBrakePadWearPercentage                           VehicleProperty = (((785 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaWHEEL)) + VehicleProperty(VehiclePropertyTypeFLOAT))
	VehiclePropertyBrakeFluidLevelLow                               VehicleProperty = (((786 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeBOOLEAN))
	VehiclePropertyVehiclePassiveSuspensionHeight                   VehicleProperty = (((787 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaWHEEL)) + VehicleProperty(VehiclePropertyTypeINT32))
	...
	VehiclePropertyVehicleHornEngaged                               VehicleProperty = (((832 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeBOOLEAN))
	...
	VehiclePropertyTurnSignalLightState                             VehicleProperty = (((1040 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeINT32))
	VehiclePropertyTurnSignalSwitch                                 VehicleProperty = (((1041 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeINT32))
	...
	VehiclePropertyVehicleDrivingAutomationTargetLevel              VehicleProperty = (((3919 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeINT32))
	...
	VehiclePropertyPerDisplayMaxBrightness                          VehicleProperty = (((3918 + VehicleProperty(VehiclePropertyGroupSYSTEM)) + VehicleProperty(VehicleAreaGLOBAL)) + VehicleProperty(VehiclePropertyTypeInt32Vec))
