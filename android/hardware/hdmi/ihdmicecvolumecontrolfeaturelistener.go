...
func (p *HdmiCecVolumeControlFeatureListenerProxy) OnHdmiCecVolumeControlFeature(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIHdmiCecVolumeControlFeatureListener, MethodIHdmiCecVolumeControlFeatureListenerOnHdmiCecVolumeControlFeature)
