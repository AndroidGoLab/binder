...
func (p *BinderRpcBenchmarkProxy) RepeatString(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIBinderRpcBenchmarkRepeatString, 0, _data)
	if _err != nil {
		return _result, _err
	}
...
func (p *BinderRpcBenchmarkProxy) RepeatBinder(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIBinderRpcBenchmarkRepeatBinder, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *BinderRpcBenchmarkProxy) RepeatBytes(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIBinderRpcBenchmarkRepeatBytes, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *BinderRpcBenchmarkProxy) GimmeBinder(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIBinderRpcBenchmarkGimmeBinder, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *BinderRpcBenchmarkProxy) WaitGimmesDestroyed(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIBinderRpcBenchmarkWaitGimmesDestroyed, 0, _data)
	if _err != nil {
		return _err
	}
	defer _reply.Recycle()
