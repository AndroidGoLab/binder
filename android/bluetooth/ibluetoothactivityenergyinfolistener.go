...
func (p *BluetoothActivityEnergyInfoListenerProxy) OnBluetoothActivityEnergyInfoAvailable(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothActivityEnergyInfoListener, MethodIBluetoothActivityEnergyInfoListenerOnBluetoothActivityEnergyInfoAvailable)
