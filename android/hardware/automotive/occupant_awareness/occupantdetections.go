...
var _ parcel.Parcelable = (*OccupantDetections)(nil)
...
func (s *OccupantDetections) MarshalParcel(
	...
	if s.Detections == nil {
		...
		p.WriteInt32(int32(len(s.Detections)))
		for _, _item := range s.Detections {
			p.WriteInt32(1)
...
func (s *OccupantDetections) UnmarshalParcel(
	...
	if _count0 >= 0 {
		s.Detections = make([]OccupantDetection, _count0)
		for _i := int32(0); _i < _count0; _i++ {
			if _, _err = p.ReadInt32(); _err != nil {
				return _err
			}
			if _err = s.Detections[_i].UnmarshalParcel(p); _err != nil {
				return _err
			}
		}
	}
