...
func (p *RemoteProvisioningProxy) GetRegistration(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIRemoteProvisioning, MethodIRemoteProvisioningGetRegistration)
	_compiledDescs := []string{
		"Ljava/lang/String;",
		"Landroid/security/rkp/IGetRegistrationCallback;",
	}
