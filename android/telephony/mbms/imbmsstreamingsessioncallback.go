...
func (p *MbmsStreamingSessionCallbackProxy) OnError(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIMbmsStreamingSessionCallback, MethodIMbmsStreamingSessionCallbackOnError)
...
func (p *MbmsStreamingSessionCallbackProxy) OnStreamingServicesUpdated(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIMbmsStreamingSessionCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIMbmsStreamingSessionCallback, MethodIMbmsStreamingSessionCallbackOnStreamingServicesUpdated)
	_compiledDescs := []string{
		"Ljava/util/List;",
	}
	if _sig == nil || binder.SignatureMatches(_compiledDescs, _sig) {
