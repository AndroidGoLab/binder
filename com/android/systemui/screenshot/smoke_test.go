...
func TestSmoke_CrossProfileServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewCrossProfileServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("CrossProfileServiceProxy: %d/%d passed, %d panicked, %d failed",
