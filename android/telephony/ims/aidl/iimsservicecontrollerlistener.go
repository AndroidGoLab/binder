...
func (p *ImsServiceControllerListenerProxy) OnUpdateSupportedImsFeatures(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIImsServiceControllerListener, MethodIImsServiceControllerListenerOnUpdateSupportedImsFeatures)
