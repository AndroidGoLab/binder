...
func (p *SyncAdapterUnsyncableAccountCallbackProxy) OnUnsyncableAccountDone(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISyncAdapterUnsyncableAccountCallback, MethodISyncAdapterUnsyncableAccountCallbackOnUnsyncableAccountDone)
