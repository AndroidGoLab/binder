...
func (p *WeakEscrowTokenActivatedListenerProxy) OnWeakEscrowTokenActivated(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIWeakEscrowTokenActivatedListener, MethodIWeakEscrowTokenActivatedListenerOnWeakEscrowTokenActivated)
