...
func TestSmoke_AmbientContextDetectionServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewAmbientContextDetectionServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("AmbientContextDetectionServiceProxy: %d/%d passed, %d panicked, %d failed",
