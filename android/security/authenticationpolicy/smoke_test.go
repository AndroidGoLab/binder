...
func TestSmoke_AuthenticationPolicyServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewAuthenticationPolicyServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("AuthenticationPolicyServiceProxy: %d/%d passed, %d panicked, %d failed",
