...
func (p *ImsExternalCallStateListenerProxy) OnImsExternalCallStateUpdate(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIImsExternalCallStateListener, MethodIImsExternalCallStateListenerOnImsExternalCallStateUpdate)
