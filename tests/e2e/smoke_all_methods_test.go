...
import (
	...
	genAdmin "github.com/xaionaro-go/aidl/android/app/admin"
	genAmbientContext "github.com/xaionaro-go/aidl/android/app/ambientcontext"
	genApp "github.com/xaionaro-go/aidl/android/app"
	genAutofill "github.com/xaionaro-go/aidl/android/view/autofill"
	genBackup "github.com/xaionaro-go/aidl/android/app/backup"
	genBiometrics "github.com/xaionaro-go/aidl/android/hardware/biometrics"
	genBlob "github.com/xaionaro-go/aidl/android/app/blob"
	genCompanion "github.com/xaionaro-go/aidl/android/companion"
	genContent "github.com/xaionaro-go/aidl/android/content"
	genContentCapture "github.com/xaionaro-go/aidl/android/view/contentcapture"
	genContentSuggestions "github.com/xaionaro-go/aidl/android/app/contentsuggestions"
	genContextualSearch "github.com/xaionaro-go/aidl/android/app/contextualsearch"
	genCredentials "github.com/xaionaro-go/aidl/android/credentials"
	genDebug "github.com/xaionaro-go/aidl/android/debug"
	genDeviceState "github.com/xaionaro-go/aidl/android/hardware/devicestate"
	genDisplay "github.com/xaionaro-go/aidl/android/hardware/display"
	genDomain "github.com/xaionaro-go/aidl/android/content/pm/verify/domain"
	genDreams "github.com/xaionaro-go/aidl/android/service/dreams"
	genFace "github.com/xaionaro-go/aidl/android/hardware/face"
	genFingerprint "github.com/xaionaro-go/aidl/android/hardware/fingerprint"
	genFlags "github.com/xaionaro-go/aidl/android/flags"
	genGui "github.com/xaionaro-go/aidl/android/gui"
	genImage "github.com/xaionaro-go/aidl/android/os/image"
	genIncremental "github.com/xaionaro-go/aidl/android/os/incremental"
	genInput "github.com/xaionaro-go/aidl/android/hardware/input"
	genIntegrity "github.com/xaionaro-go/aidl/android/content/integrity"
	genLights "github.com/xaionaro-go/aidl/android/hardware/lights"
	genLocation "github.com/xaionaro-go/aidl/android/location"
	genLogcat "github.com/xaionaro-go/aidl/android/os/logcat"
	genMedia "github.com/xaionaro-go/aidl/android/media"
	genMediaMetrics "github.com/xaionaro-go/aidl/android/media/metrics"
	genMemtrack "github.com/xaionaro-go/aidl/android/hardware/memtrack"
	genMidi "github.com/xaionaro-go/aidl/android/media/midi"
	genMusicRecognition "github.com/xaionaro-go/aidl/android/media/musicrecognition"
	genNet "github.com/xaionaro-go/aidl/android/net"
	genOnDeviceIntelligence "github.com/xaionaro-go/aidl/android/app/ondeviceintelligence"
	genOs "github.com/xaionaro-go/aidl/android/os"
	genOsStorage "github.com/xaionaro-go/aidl/android/os/storage"
	genPeople "github.com/xaionaro-go/aidl/android/app/people"
	genPermission "github.com/xaionaro-go/aidl/android/permission"
	genPinner "github.com/xaionaro-go/aidl/android/app/pinner"
	genPm "github.com/xaionaro-go/aidl/android/content/pm"
	genPrediction "github.com/xaionaro-go/aidl/android/app/prediction"
	genPrint "github.com/xaionaro-go/aidl/android/print"
	genProjection "github.com/xaionaro-go/aidl/android/media/projection"
	genRollback "github.com/xaionaro-go/aidl/android/content/rollback"
	genSe "github.com/xaionaro-go/aidl/android/se/omapi"
	genSearchUI "github.com/xaionaro-go/aidl/android/app/search"
	genSecurity "github.com/xaionaro-go/aidl/android/security"
	genSensorPrivacy "github.com/xaionaro-go/aidl/android/hardware"
	genSession "github.com/xaionaro-go/aidl/android/media/session"
	genSlice "github.com/xaionaro-go/aidl/android/app/slice"
	genSmartspace "github.com/xaionaro-go/aidl/android/app/smartspace"
	genSoundTriggerMiddleware "github.com/xaionaro-go/aidl/android/media/soundtrigger_middleware"
	genSpeechTts "github.com/xaionaro-go/aidl/android/speech/tts"
	genSvcTextClassifier "github.com/xaionaro-go/aidl/android/service/textclassifier"
	genTimeDetector "github.com/xaionaro-go/aidl/android/app/timedetector"
	genTimeZoneDetector "github.com/xaionaro-go/aidl/android/app/timezonedetector"
	genTracing "github.com/xaionaro-go/aidl/android/tracing"
	genTranslation "github.com/xaionaro-go/aidl/android/view/translation"
	genTrust "github.com/xaionaro-go/aidl/android/app/trust"
	genUsage "github.com/xaionaro-go/aidl/android/app/usage"
	genVcn "github.com/xaionaro-go/aidl/android/net/vcn"
	genView "github.com/xaionaro-go/aidl/android/view"
	genVirtual "github.com/xaionaro-go/aidl/android/companion/virtual"
	genVirtualNative "github.com/xaionaro-go/aidl/android/companion/virtualnative"
	genWallpaperEffects "github.com/xaionaro-go/aidl/android/app/wallpapereffectsgeneration"
	genWearable "github.com/xaionaro-go/aidl/android/app/wearable"
	genWebkit "github.com/xaionaro-go/aidl/android/webkit"

	// com.android.internal proxies
	genInternalApp "github.com/xaionaro-go/aidl/com/android/internal_/app"
	genInternalFonts "github.com/xaionaro-go/aidl/com/android/internal_/graphics/fonts"
	genInternalTelecom "github.com/xaionaro-go/aidl/com/android/internal_/telecom"

	// HAL proxies
	genAuthSecret "github.com/xaionaro-go/aidl/android/hardware/authsecret"
	genHwBiometricsFace "github.com/xaionaro-go/aidl/android/hardware/biometrics/face"
	genHwBiometricsFingerprint "github.com/xaionaro-go/aidl/android/hardware/biometrics/fingerprint"
	genHwBt "github.com/xaionaro-go/aidl/android/hardware/bluetooth"
	genHwBtAudio "github.com/xaionaro-go/aidl/android/hardware/bluetooth/audio"
	genC2 "github.com/xaionaro-go/aidl/android/hardware/media/c2"
	...
	genGnss "github.com/xaionaro-go/aidl/android/hardware/gnss"
	genHealth "github.com/xaionaro-go/aidl/android/hardware/health"
	genHwLight "github.com/xaionaro-go/aidl/android/hardware/light"
	genHwPower "github.com/xaionaro-go/aidl/android/hardware/power"
	genHwPowerStats "github.com/xaionaro-go/aidl/android/hardware/power/stats"
	genHwUsb "github.com/xaionaro-go/aidl/android/hardware/usb"
	genHwVibrator "github.com/xaionaro-go/aidl/android/hardware/vibrator"
	genIdentity "github.com/xaionaro-go/aidl/android/hardware/identity"
	genKeyMint "github.com/xaionaro-go/aidl/android/hardware/security/keymint"
	genKeystore2 "github.com/xaionaro-go/aidl/android/system/keystore2"
	genNN "github.com/xaionaro-go/aidl/android/hardware/neuralnetworks"
	genNetd "github.com/xaionaro-go/aidl/android/system/net/netd"
	genRadioConfig "github.com/xaionaro-go/aidl/android/hardware/radio/config"
	genRadioData "github.com/xaionaro-go/aidl/android/hardware/radio/data"
	genRadioIms "github.com/xaionaro-go/aidl/android/hardware/radio/ims"
	genRadioImsMedia "github.com/xaionaro-go/aidl/android/hardware/radio/ims/media"
	genRadioMessaging "github.com/xaionaro-go/aidl/android/hardware/radio/messaging"
	genRadioModem "github.com/xaionaro-go/aidl/android/hardware/radio/modem"
	genRadioNetwork "github.com/xaionaro-go/aidl/android/hardware/radio/network"
	genRadioSim "github.com/xaionaro-go/aidl/android/hardware/radio/sim"
	genRadioVoice "github.com/xaionaro-go/aidl/android/hardware/radio/voice"
	genRebootEscrow "github.com/xaionaro-go/aidl/android/hardware/rebootescrow"
	genSecureClock "github.com/xaionaro-go/aidl/android/hardware/security/secureclock"
	genSensors "github.com/xaionaro-go/aidl/android/hardware/sensors"
	genSharedSecret "github.com/xaionaro-go/aidl/android/hardware/security/sharedsecret"
	genSupplicant "github.com/xaionaro-go/aidl/android/hardware/wifi/supplicant"
	genSuspend "github.com/xaionaro-go/aidl/android/system/suspend"
	genWifi "github.com/xaionaro-go/aidl/android/hardware/wifi"
)
