...
func TestSmoke_GlanceableHubWidgetManagerServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewGlanceableHubWidgetManagerServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("GlanceableHubWidgetManagerServiceProxy: %d/%d passed, %d panicked, %d failed",
