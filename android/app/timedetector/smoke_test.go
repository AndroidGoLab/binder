...
func TestSmoke_TimeDetectorServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewTimeDetectorServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("TimeDetectorServiceProxy: %d/%d passed, %d panicked, %d failed",
