...
func TestSmoke_HalSoundDoseCallbackProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewHalSoundDoseCallbackProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("HalSoundDoseCallbackProxy: %d/%d passed, %d panicked, %d failed",
