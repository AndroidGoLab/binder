...
func (p *WindowInfosListenerProxy) OnWindowInfosChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIWindowInfosListener, MethodIWindowInfosListenerOnWindowInfosChanged)
	_compiledDescs := []string{
		"Landroid/gui/WindowInfosUpdate;",
	}
