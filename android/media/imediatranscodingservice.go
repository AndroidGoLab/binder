...
func (p *MediaTranscodingServiceProxy) RegisterClient(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIMediaTranscodingService, MethodIMediaTranscodingServiceRegisterClient)
	_compiledDescs := []string{
		"Landroid/media/ITranscodingClientCallback;",
		"Ljava/lang/String;",
		"Ljava/lang/String;",
	}
