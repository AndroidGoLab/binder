...
func (p *InputFlingerRustProxy) CreateInputFilter(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIInputFlingerRust, MethodIInputFlingerRustCreateInputFilter)
	_compiledDescs := []string{
		"Lcom/android/server/inputflinger/IInputFilter/IInputFilterCallbacks;",
	}
