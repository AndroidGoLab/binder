...
const DescriptorIPip = "com.android.wm.shell.pip.IPip"
...
type IPip interface {
	...
	StopSwipePipToHome(ctx context.Context, taskId int32, componentName content.ComponentName, destinationBounds graphics.Rect, overlay view.SurfaceControl) error
...
func (s *PipStub) OnTransaction(
	...
	case TransactionIPipStopSwipePipToHome:
		...
		_err = s.Impl.StopSwipePipToHome(ctx, _arg_taskId, _arg_componentName, _arg_destinationBounds, _arg_overlay)
		_ = _err
		return nil, nil
...
func (w *pipStubWrapper) StopSwipePipToHome(
	...
	return w.impl.StopSwipePipToHome(ctx, taskId, componentName, destinationBounds, overlay)
}
