...
func TestSmoke_AppClipsScreenshotHelperServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewAppClipsScreenshotHelperServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("AppClipsScreenshotHelperServiceProxy: %d/%d passed, %d panicked, %d failed",
