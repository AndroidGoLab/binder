...
var _ parcel.Parcelable = (*BufferCacheUpdateCacheBuffers)(nil)
...
func (s *BufferCacheUpdateCacheBuffers) MarshalParcel(
	...
	if s.Attachments == nil {
		...
		for _, _item := range s.Attachments {
			p.WriteInt32(1)
...
func (s *BufferCacheUpdateCacheBuffers) UnmarshalParcel(
	...
	if _count0 >= 0 {
		s.Attachments = make([]BufferAttachment, _count0)
		for _i := int32(0); _i < _count0; _i++ {
			if _, _err = p.ReadInt32(); _err != nil {
				return _err
			}
			if _err = s.Attachments[_i].UnmarshalParcel(p); _err != nil {
				return _err
			}
		}
	}
