...
func (p *RestrictionsManagerProxy) GetApplicationRestrictions(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRestrictionsManagerGetApplicationRestrictions, 0, _data)
	if _err != nil {
		return _result, _err
	}
...
func (p *RestrictionsManagerProxy) GetApplicationRestrictionsPerAdminForUser(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRestrictionsManagerGetApplicationRestrictionsPerAdminForUser, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *RestrictionsManagerProxy) HasRestrictionsProvider(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRestrictionsManagerHasRestrictionsProvider, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *RestrictionsManagerProxy) RequestPermission(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRestrictionsManagerRequestPermission, 0, _data)
	if _err != nil {
		return _err
	}
	defer _reply.Recycle()
...
func (p *RestrictionsManagerProxy) NotifyPermissionResponse(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRestrictionsManagerNotifyPermissionResponse, 0, _data)
	if _err != nil {
		return _err
	}
	defer _reply.Recycle()
...
func (p *RestrictionsManagerProxy) CreateLocalApprovalIntent(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRestrictionsManagerCreateLocalApprovalIntent, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
