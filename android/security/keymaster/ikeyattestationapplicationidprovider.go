...
const DescriptorIKeyAttestationApplicationIdProvider = "android.security.keymaster.IKeyAttestationApplicationIdProvider"
...
type IKeyAttestationApplicationIdProvider interface {
	...
	GetKeyAttestationApplicationId(ctx context.Context, uid int32) (interface{}, error)
}
