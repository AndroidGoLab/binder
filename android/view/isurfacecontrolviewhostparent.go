...
func (p *SurfaceControlViewHostParentProxy) UpdateParams(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISurfaceControlViewHostParent, MethodISurfaceControlViewHostParentUpdateParams)
...
func (p *SurfaceControlViewHostParentProxy) ForwardBackKeyToParent(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorISurfaceControlViewHostParent)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISurfaceControlViewHostParent, MethodISurfaceControlViewHostParentForwardBackKeyToParent)
	_compiledDescs := []string{
