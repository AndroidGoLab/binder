...
func (p *ServiceListExportSessionProxy) ExportServiceList(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIServiceListExportSessionExportServiceList, 0, _data)
	if _err != nil {
		return _result, _err
	}
...
func (p *ServiceListExportSessionProxy) Release(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIServiceListExportSessionRelease, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
