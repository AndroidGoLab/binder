...
func TestSmoke_InputFilterCallbacksProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewInputFilterCallbacksProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("InputFilterCallbacksProxy: %d/%d passed, %d panicked, %d failed",
