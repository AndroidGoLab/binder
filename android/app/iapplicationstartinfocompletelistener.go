...
func (p *ApplicationStartInfoCompleteListenerProxy) OnApplicationStartInfoComplete(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIApplicationStartInfoCompleteListener, MethodIApplicationStartInfoCompleteListenerOnApplicationStartInfoComplete)
