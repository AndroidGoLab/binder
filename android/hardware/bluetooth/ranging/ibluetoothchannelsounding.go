...
func (p *BluetoothChannelSoundingProxy) OpenSession(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBluetoothChannelSounding)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothChannelSounding, MethodIBluetoothChannelSoundingOpenSession)
	_compiledDescs := []string{
		"Landroid/hardware/bluetooth/ranging/BluetoothChannelSoundingParameters;",
		"Landroid/hardware/bluetooth/ranging/IBluetoothChannelSoundingSessionCallback;",
	}
