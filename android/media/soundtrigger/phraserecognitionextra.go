...
var _ parcel.Parcelable = (*PhraseRecognitionExtra)(nil)
...
func (s *PhraseRecognitionExtra) MarshalParcel(
	...
	if s.Levels == nil {
		...
		p.WriteInt32(int32(len(s.Levels)))
		for _, _item := range s.Levels {
			p.WriteInt32(1)
...
func (s *PhraseRecognitionExtra) UnmarshalParcel(
	...
	if _count0 >= 0 {
		s.Levels = make([]ConfidenceLevel, _count0)
		for _i := int32(0); _i < _count0; _i++ {
			if _, _err = p.ReadInt32(); _err != nil {
				return _err
			}
			if _err = s.Levels[_i].UnmarshalParcel(p); _err != nil {
				return _err
			}
		}
	}
