...
func (p *StreamingResponseCallbackProxy) OnNewContent(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIStreamingResponseCallback, MethodIStreamingResponseCallbackOnNewContent)
...
func (p *StreamingResponseCallbackProxy) OnSuccess(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIStreamingResponseCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIStreamingResponseCallback, MethodIStreamingResponseCallbackOnSuccess)
	_compiledDescs := []string{
		"Landroid/app/ondeviceintelligence/Content;",
	}
	if _sig == nil || binder.SignatureMatches(_compiledDescs, _sig) {
...
func (p *StreamingResponseCallbackProxy) OnFailure(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIStreamingResponseCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIStreamingResponseCallback, MethodIStreamingResponseCallbackOnFailure)
	_compiledDescs := []string{
		"I",
		"Ljava/lang/String;",
