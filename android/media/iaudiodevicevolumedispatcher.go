...
func (p *AudioDeviceVolumeDispatcherProxy) DispatchDeviceVolumeChanged(
	...
	_, _err := p.remote.Transact(ctx, TransactionIAudioDeviceVolumeDispatcherDispatchDeviceVolumeChanged, binder.FlagOneway, _data)
	return _err
}
...
func (p *AudioDeviceVolumeDispatcherProxy) DispatchDeviceVolumeAdjusted(
	...
	_, _err := p.remote.Transact(ctx, TransactionIAudioDeviceVolumeDispatcherDispatchDeviceVolumeAdjusted, binder.FlagOneway, _data)
	return _err
}
