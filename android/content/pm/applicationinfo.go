...
func (s *ApplicationInfo) UnmarshalParcel(
	...
	if _, _err = p.ReadInt64(); _err != nil { // skip StorageUuid.getMostSignificantBits()
		return _err
	}
	if _, _err = p.ReadInt64(); _err != nil { // skip StorageUuid.getLeastSignificantBits()
		return _err
	}
	...
	s.NativeLibraryRootRequiresIsa, _err = p.ReadBool()
	if _err != nil {
		return _err
	}
	...
	return nil // opaque ResourceDirs: cannot skip without known wire format
	return nil // opaque OverlayPaths: cannot skip without known wire format
	...
	return nil // opaque SharedLibraryFiles: cannot skip without known wire format
	return nil // opaque SharedLibraryInfos: cannot skip without known wire format
	return nil // opaque OptionalSharedLibraryInfos: cannot skip without known wire format
	...
	return nil // opaque SplitClassLoaderNames: cannot skip without known wire format
	...
	s.HiddenUntilInstalled, _err = p.ReadBool()
	if _err != nil {
		return _err
	}
	...
	s.AllowCrossUidActivitySwitchFromBelow, _err = p.ReadBool()
	if _err != nil {
		return _err
	}
	return nil
