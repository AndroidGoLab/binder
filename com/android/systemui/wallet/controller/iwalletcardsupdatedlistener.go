...
import (
	"context"
	"fmt"
	quickaccesswallet "github.com/AndroidGoLab/binder/android/service/quickaccesswallet"
...
func (p *WalletCardsUpdatedListenerProxy) RegisterNewWalletCards(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIWalletCardsUpdatedListener, MethodIWalletCardsUpdatedListenerRegisterNewWalletCards)
