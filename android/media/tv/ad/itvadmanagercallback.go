...
func (p *TvAdManagerCallbackProxy) OnAdServiceAdded(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorITvAdManagerCallback, MethodITvAdManagerCallbackOnAdServiceAdded)
...
func (p *TvAdManagerCallbackProxy) OnAdServiceRemoved(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorITvAdManagerCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorITvAdManagerCallback, MethodITvAdManagerCallbackOnAdServiceRemoved)
	_compiledDescs := []string{
		"Ljava/lang/String;",
	}
	if _sig == nil || binder.SignatureMatches(_compiledDescs, _sig) {
...
func (p *TvAdManagerCallbackProxy) OnAdServiceUpdated(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorITvAdManagerCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorITvAdManagerCallback, MethodITvAdManagerCallbackOnAdServiceUpdated)
	_compiledDescs := []string{
		"Ljava/lang/String;",
	}
	if _sig == nil || binder.SignatureMatches(_compiledDescs, _sig) {
