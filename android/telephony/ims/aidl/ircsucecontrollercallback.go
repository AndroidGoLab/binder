...
func (p *RcsUceControllerCallbackProxy) OnCapabilitiesReceived(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIRcsUceControllerCallback, MethodIRcsUceControllerCallbackOnCapabilitiesReceived)
...
func (p *RcsUceControllerCallbackProxy) OnComplete(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIRcsUceControllerCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIRcsUceControllerCallback, MethodIRcsUceControllerCallbackOnComplete)
	_compiledDescs := []string{
...
func (p *RcsUceControllerCallbackProxy) OnError(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIRcsUceControllerCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIRcsUceControllerCallback, MethodIRcsUceControllerCallbackOnError)
	_compiledDescs := []string{
		"I",
		"J",
		"Landroid/telephony/ims/SipDetails;",
