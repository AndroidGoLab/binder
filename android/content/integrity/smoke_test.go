...
func TestSmoke_AppIntegrityManagerProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewAppIntegrityManagerProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("AppIntegrityManagerProxy: %d/%d passed, %d panicked, %d failed",
