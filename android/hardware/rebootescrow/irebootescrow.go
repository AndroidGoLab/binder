...
func (p *RebootEscrowProxy) StoreKey(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRebootEscrowStoreKey, 0, _data)
	if _err != nil {
		return _err
	}
...
func (p *RebootEscrowProxy) RetrieveKey(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRebootEscrowRetrieveKey, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
