...
import (
	"context"
	"fmt"
	mediaSession "github.com/AndroidGoLab/binder/android/media/session"
...
func (p *PlayerCallbackProxy) OnSessionChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIPlayerCallback, MethodIPlayerCallbackOnSessionChanged)
