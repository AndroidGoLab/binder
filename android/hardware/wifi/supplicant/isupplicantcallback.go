...
func (p *SupplicantCallbackProxy) OnInterfaceCreated(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISupplicantCallback, MethodISupplicantCallbackOnInterfaceCreated)
...
func (p *SupplicantCallbackProxy) OnInterfaceRemoved(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorISupplicantCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISupplicantCallback, MethodISupplicantCallbackOnInterfaceRemoved)
	_compiledDescs := []string{
		"Ljava/lang/String;",
	}
	if _sig == nil || binder.SignatureMatches(_compiledDescs, _sig) {
