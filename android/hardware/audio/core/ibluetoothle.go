...
func (p *BluetoothLeProxy) SetEnabled(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBluetoothLe)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothLe, MethodIBluetoothLeSetEnabled)
...
func (p *BluetoothLeProxy) ReconfigureOffload(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBluetoothLe)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothLe, MethodIBluetoothLeReconfigureOffload)
	_compiledDescs := []string{
