...
func (p *ImsUtProxy) Close(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtClose, 0, _data)
	if _err != nil {
		return _err
	}
...
func (p *ImsUtProxy) QueryCallBarring(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCallBarring, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) QueryCallForward(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCallForward, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) QueryCallWaiting(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCallWaiting, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) QueryCLIR(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCLIR, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) QueryCLIP(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCLIP, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) QueryCOLR(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCOLR, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) QueryCOLP(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCOLP, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) Transact(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtTransact, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCallBarring(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCallBarring, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCallForward(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCallForward, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCallWaiting(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCallWaiting, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCLIR(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCLIR, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCLIP(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCLIP, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCOLR(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCOLR, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCOLP(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCOLP, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) SetListener(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtSetListener, 0, _data)
	if _err != nil {
		return _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) QueryCallBarringForServiceClass(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtQueryCallBarringForServiceClass, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCallBarringForServiceClass(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCallBarringForServiceClass, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *ImsUtProxy) UpdateCallBarringWithPassword(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIImsUtUpdateCallBarringWithPassword, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
