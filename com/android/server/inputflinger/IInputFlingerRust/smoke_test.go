...
func TestSmoke_InputFlingerRustBootstrapCallbackProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewInputFlingerRustBootstrapCallbackProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("InputFlingerRustBootstrapCallbackProxy: %d/%d passed, %d panicked, %d failed",
