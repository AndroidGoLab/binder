...
func (p *GnssPowerIndicationProxy) SetCallback(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIGnssPowerIndication, MethodIGnssPowerIndicationSetCallback)
	_compiledDescs := []string{
		"Landroid/hardware/gnss/IGnssPowerIndicationCallback;",
	}
