...
import (
	"context"
	"fmt"
	appWallpapereffectsgeneration "github.com/AndroidGoLab/binder/android/app/wallpapereffectsgeneration"
...
func (p *WallpaperEffectsGenerationServiceProxy) OnGenerateCinematicEffect(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIWallpaperEffectsGenerationService, MethodIWallpaperEffectsGenerationServiceOnGenerateCinematicEffect)
