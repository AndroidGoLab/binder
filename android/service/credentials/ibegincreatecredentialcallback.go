...
func (p *BeginCreateCredentialCallbackProxy) OnSuccess(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBeginCreateCredentialCallback, MethodIBeginCreateCredentialCallbackOnSuccess)
...
func (p *BeginCreateCredentialCallbackProxy) OnFailure(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBeginCreateCredentialCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBeginCreateCredentialCallback, MethodIBeginCreateCredentialCallbackOnFailure)
	_compiledDescs := []string{
		"Ljava/lang/String;",
...
func (p *BeginCreateCredentialCallbackProxy) OnCancellable(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIBeginCreateCredentialCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBeginCreateCredentialCallback, MethodIBeginCreateCredentialCallbackOnCancellable)
	_compiledDescs := []string{
