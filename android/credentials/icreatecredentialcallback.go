...
func (p *CreateCredentialCallbackProxy) OnPendingIntent(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICreateCredentialCallback, MethodICreateCredentialCallbackOnPendingIntent)
...
func (p *CreateCredentialCallbackProxy) OnResponse(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICreateCredentialCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICreateCredentialCallback, MethodICreateCredentialCallbackOnResponse)
	_compiledDescs := []string{
...
func (p *CreateCredentialCallbackProxy) OnError(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorICreateCredentialCallback)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorICreateCredentialCallback, MethodICreateCredentialCallbackOnError)
	_compiledDescs := []string{
		"Ljava/lang/String;",
		"Ljava/lang/String;",
	}
