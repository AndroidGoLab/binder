...
func (p *StrategyPreferredDevicesDispatcherProxy) DispatchPrefDevicesChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIStrategyPreferredDevicesDispatcher, MethodIStrategyPreferredDevicesDispatcherDispatchPrefDevicesChanged)
