...
func TestSmoke_AudioPolicyCallbackProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewAudioPolicyCallbackProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("AudioPolicyCallbackProxy: %d/%d passed, %d panicked, %d failed",
