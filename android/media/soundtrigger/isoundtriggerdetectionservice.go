...
func (p *SoundTriggerDetectionServiceProxy) SetClient(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISoundTriggerDetectionService, MethodISoundTriggerDetectionServiceSetClient)
...
func (p *SoundTriggerDetectionServiceProxy) RemoveClient(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorISoundTriggerDetectionService)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISoundTriggerDetectionService, MethodISoundTriggerDetectionServiceRemoveClient)
	_compiledDescs := []string{
		"Landroid/os/ParcelUuid;",
	}
	if _sig == nil || binder.SignatureMatches(_compiledDescs, _sig) {
...
func (p *SoundTriggerDetectionServiceProxy) OnGenericRecognitionEvent(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorISoundTriggerDetectionService)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISoundTriggerDetectionService, MethodISoundTriggerDetectionServiceOnGenericRecognitionEvent)
	_compiledDescs := []string{
		"Landroid/os/ParcelUuid;",
		"I",
...
func (p *SoundTriggerDetectionServiceProxy) OnError(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorISoundTriggerDetectionService)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISoundTriggerDetectionService, MethodISoundTriggerDetectionServiceOnError)
	_compiledDescs := []string{
		"Landroid/os/ParcelUuid;",
		"I",
		"I",
...
func (p *SoundTriggerDetectionServiceProxy) OnStopOperation(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorISoundTriggerDetectionService)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISoundTriggerDetectionService, MethodISoundTriggerDetectionServiceOnStopOperation)
	_compiledDescs := []string{
		"Landroid/os/ParcelUuid;",
		"I",
	}
