...
func TestSmoke_AssistHandleServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewAssistHandleServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("AssistHandleServiceProxy: %d/%d passed, %d panicked, %d failed",
