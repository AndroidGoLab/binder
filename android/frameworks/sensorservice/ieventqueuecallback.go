...
import (
	"context"
	"fmt"
	sensors "github.com/AndroidGoLab/binder/android/hardware/sensors"
...
func (p *EventQueueCallbackProxy) OnEvent(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIEventQueueCallback, MethodIEventQueueCallbackOnEvent)
