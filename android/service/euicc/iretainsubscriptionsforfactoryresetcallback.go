...
func (p *RetainSubscriptionsForFactoryResetCallbackProxy) OnComplete(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIRetainSubscriptionsForFactoryResetCallback, MethodIRetainSubscriptionsForFactoryResetCallbackOnComplete)
