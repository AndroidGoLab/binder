...
func (p *ActivityRecognitionHardwareWatcherProxy) OnInstanceChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIActivityRecognitionHardwareWatcher, MethodIActivityRecognitionHardwareWatcherOnInstanceChanged)
