...
var _ parcel.Parcelable = (*IConfigurableQuerySupportedValuesResult)(nil)

func (s *IConfigurableQuerySupportedValuesResult) MarshalParcel(
	p *parcel.Parcel,
) error {
...
func (s *IConfigurableQuerySupportedValuesResult) UnmarshalParcel(
	...
	if _count0 >= 0 {
		s.Values = make([]FieldSupportedValuesQueryResult, _count0)
