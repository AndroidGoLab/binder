...
func (p *SatelliteProvisionStateCallbackProxy) OnSatelliteProvisionStateChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorISatelliteProvisionStateCallback, MethodISatelliteProvisionStateCallbackOnSatelliteProvisionStateChanged)
