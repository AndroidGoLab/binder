...
func TestGenBatch5_SecurityState(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("security_state"))
	requireOrSkip(t, err)
...
func TestGenBatch5_SystemConfig_GetDisabledUntilUsedPreinstalledCarrierApps(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("system_config"))
	requireOrSkip(t, err)
...
func TestGenBatch5_USB_GetDeviceList(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("usb"))
	requireOrSkip(t, err)
...
func TestGenBatch5_Wallpaper(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("wallpaper"))
	requireOrSkip(t, err)
...
func TestGenBatch5_Trust(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("trust"))
	requireOrSkip(t, err)
...
func TestGenBatch5_SensorPrivacy(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("sensor_privacy"))
	requireOrSkip(t, err)
...
func TestGenBatch5_SecureElement_GetReaders(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("secure_element"))
	requireOrSkip(t, err)
...
func TestGenBatch5_Print_GetPrintJobInfos(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("print"))
	requireOrSkip(t, err)
...
func TestGenBatch5_PowerStats(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("powerstats"))
	requireOrSkip(t, err)
...
func TestGenBatch5_Rollback(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("rollback"))
	requireOrSkip(t, err)
...
func TestGenBatch5_Recovery(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("recovery"))
	requireOrSkip(t, err)
...
func TestGenBatch5_Slice_HasSliceAccess(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("slice"))
	requireOrSkip(t, err)
...
func TestGenBatch5_Search_GetGlobalSearchActivities(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("search"))
	requireOrSkip(t, err)
...
func TestGenBatch5_VirtualDevice_GetVirtualDevices(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("virtualdevice"))
	requireOrSkip(t, err)
...
func TestGenBatch5_SystemUpdate(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("system_update"))
	requireOrSkip(t, err)
...
func TestGenBatch5_UsageStats(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("usagestats"))
	requireOrSkip(t, err)
...
func TestGenBatch5_VcnManagement(t *testing.T) {
	...
	driver := openBinder(t)
	sm := servicemanager.New(driver)
	svc, err := sm.GetService(ctx, servicemanager.ServiceName("vcn_management"))
	requireOrSkip(t, err)
