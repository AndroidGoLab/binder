...
func (p *BluetoothQualityReportReadyCallbackProxy) OnBluetoothQualityReportReady(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothQualityReportReadyCallback, MethodIBluetoothQualityReportReadyCallbackOnBluetoothQualityReportReady)
