...
func (p *BluetoothPreferredAudioProfilesCallbackProxy) OnPreferredAudioProfilesChanged(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIBluetoothPreferredAudioProfilesCallback, MethodIBluetoothPreferredAudioProfilesCallbackOnPreferredAudioProfilesChanged)
