...
import (
	"context"
	"fmt"
	serviceEuicc "github.com/AndroidGoLab/binder/android/service/euicc"
...
func (p *GetProfileCallbackProxy) OnComplete(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIGetProfileCallback, MethodIGetProfileCallbackOnComplete)
