...
func (p *RadioVoiceProxy) AcceptCall(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceAcceptCall, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) CancelPendingUssd(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceCancelPendingUssd, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) Conference(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceConference, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) Dial(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceDial, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) EmergencyDial(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceEmergencyDial, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) ExitEmergencyCallbackMode(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceExitEmergencyCallbackMode, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) ExplicitCallTransfer(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceExplicitCallTransfer, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetCallForwardStatus(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetCallForwardStatus, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetCallWaiting(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetCallWaiting, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetClip(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetClip, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetClir(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetClir, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetCurrentCalls(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetCurrentCalls, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetLastCallFailCause(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetLastCallFailCause, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetMute(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetMute, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetPreferredVoicePrivacy(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetPreferredVoicePrivacy, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) GetTtyMode(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceGetTtyMode, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) HandleStkCallSetupRequestFromSim(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceHandleStkCallSetupRequestFromSim, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) Hangup(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceHangup, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) HangupForegroundResumeBackground(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceHangupForegroundResumeBackground, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) HangupWaitingOrBackground(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceHangupWaitingOrBackground, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) IsVoNrEnabled(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceIsVoNrEnabled, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) RejectCall(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceRejectCall, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) ResponseAcknowledgement(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceResponseAcknowledgement, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SendBurstDtmf(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSendBurstDtmf, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SendCdmaFeatureCode(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSendCdmaFeatureCode, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SendDtmf(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSendDtmf, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SendUssd(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSendUssd, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SeparateConnection(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSeparateConnection, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetCallForward(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetCallForward, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetCallWaiting(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetCallWaiting, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetClir(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetClir, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetMute(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetMute, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetPreferredVoicePrivacy(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetPreferredVoicePrivacy, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetResponseFunctions(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetResponseFunctions, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetTtyMode(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetTtyMode, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SetVoNrEnabled(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSetVoNrEnabled, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) StartDtmf(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceStartDtmf, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) StopDtmf(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceStopDtmf, binder.FlagOneway, _data)
	return _err
}
...
func (p *RadioVoiceProxy) SwitchWaitingOrHoldingAndActive(
	...
	_, _err := p.remote.Transact(ctx, TransactionIRadioVoiceSwitchWaitingOrHoldingAndActive, binder.FlagOneway, _data)
	return _err
}
