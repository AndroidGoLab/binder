...
func TestSmoke_WearableSensingServiceProxy(t *testing.T) {
	mock := testutil.NewMockBinder()
	proxy := NewWearableSensingServiceProxy(mock)
	result := testutil.SmokeTestAllMethods(t, proxy)
	t.Logf("WearableSensingServiceProxy: %d/%d passed, %d panicked, %d failed",
