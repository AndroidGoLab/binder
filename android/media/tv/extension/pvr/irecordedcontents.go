...
func (p *RecordedContentsProxy) DeleteRecordedContents(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRecordedContentsDeleteRecordedContents, 0, _data)
	if _err != nil {
		return _err
	}
...
func (p *RecordedContentsProxy) GetRecordedContentsLockInfoSync(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRecordedContentsGetRecordedContentsLockInfoSync, 0, _data)
	if _err != nil {
		return _result, _err
	}
	defer _reply.Recycle()
...
func (p *RecordedContentsProxy) GetRecordedContentsLockInfoAsync(
	...
	_reply, _err := p.remote.Transact(ctx, TransactionIRecordedContentsGetRecordedContentsLockInfoAsync, 0, _data)
	if _err != nil {
		return _err
	}
	defer _reply.Recycle()
