...
func (p *AssistDataReceiverProxy) OnHandleAssistData(
	...
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIAssistDataReceiver, MethodIAssistDataReceiverOnHandleAssistData)
...
func (p *AssistDataReceiverProxy) OnHandleAssistScreenshot(
	...
	defer _data.Recycle()
	_data.WriteInterfaceToken(DescriptorIAssistDataReceiver)
	_sig := binder.ResolveMethodSignature(p.Remote, ctx, DescriptorIAssistDataReceiver, MethodIAssistDataReceiverOnHandleAssistScreenshot)
	_compiledDescs := []string{
